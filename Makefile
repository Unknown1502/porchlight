...
.PHONY: install corpus run demo eval seeds design test injection lint docs check deploy clean

PY ?= python

install corpus run demo eval seeds design test injection lint docs check deploy clean:
	$(PY) tasks.py $@
